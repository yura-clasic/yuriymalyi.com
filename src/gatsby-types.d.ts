...
type MdxFrontmatter = {
  ...
  readonly paylink: Maybe<Scalars['String']>;
...
type MdxFrontmatterFieldSelector = {
  ...
  readonly paylink: InputMaybe<FieldSelectorEnum>;
...
type MdxFrontmatterFilterInput = {
  ...
  readonly paylink: InputMaybe<StringQueryOperatorInput>;
...
type MdxFrontmatterSortInput = {
  ...
  readonly paylink: InputMaybe<SortOrderEnum>;
...
type CourseBySlugQueryVariables = Exact<{
  id: Scalars['String'];
  previousCourseId: InputMaybe<Scalars['String']>;
  nextCourseId: InputMaybe<Scalars['String']>;
}>;


type CourseBySlugQuery = { readonly mdx: { readonly body: string | null, readonly frontmatter: { readonly title: string | null, readonly description: string | null, readonly technologies: ReadonlyArray<string | null> | null, readonly video: boolean | null, readonly paylink: string | null, readonly lang: string | null, readonly url: string | null, readonly thumbnail: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null } | null, readonly previous: { readonly frontmatter: { readonly title: string | null, readonly slug: string | null } | null } | null, readonly next: { readonly frontmatter: { readonly title: string | null, readonly slug: string | null } | null } | null };

type CoursesQueryQueryVariables = Exact<{ [key: string]: never; }>;


type CoursesQueryQuery = { readonly courses: { readonly edges: ReadonlyArray<{ readonly node: { readonly id: string, readonly frontmatter: { readonly title: string | null, readonly description: string | null, readonly slug: string | null, readonly video: boolean | null, readonly thumbnail: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null } }> } };
...
type HomePageQueryQuery = { readonly posts: { readonly edges: ReadonlyArray<{ readonly node: { readonly id: string, readonly frontmatter: { readonly title: string | null, readonly description: string | null, readonly slug: string | null, readonly tags: ReadonlyArray<string | null> | null, readonly thumbnail: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null } }> }, readonly courses: { readonly edges: ReadonlyArray<{ readonly node: { readonly id: string, readonly frontmatter: { readonly title: string | null, readonly description: string | null, readonly slug: string | null, readonly video: boolean | null, readonly thumbnail: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null } | null } }> } };
