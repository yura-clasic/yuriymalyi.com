  ...
  return (
    <Layout language="uk">
      ...
      <section className="latest-items">
        <div className="head">
          <div className="title">Останні курси</div>
          <Link to="/uk/courses" className="link">
            Всі курси
            <ArrowRightSIcon className="icon" />
          </Link>
        </div>
        <Items language="uk" type="course" items={data.courses.edges} />
      </section>

      {/* Latest Posts Section */}
      <section className="latest-items">
        <div className="head">
          <div className="title">Останні статті</div>
          <Link to="/uk/posts" className="link">
            Всі статті
            <ArrowRightSIcon className="icon" />
          </Link>
        </div>
        <Items language="uk" type="post" items={data.posts.edges} />
      </section>
    </Layout>
  )
}
